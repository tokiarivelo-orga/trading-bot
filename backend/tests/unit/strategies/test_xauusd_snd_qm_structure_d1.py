"""Unit tests for `xauusd_snd_qm_structure_d1_v1.py` — XAUUSD S&D V1/V2 +
Quasimodo + market-structure strategy, D1 Position preset. Zone timeframe
is W1, resampled in-strategy from D1 (7 D1 bars per bucket)."""
...
from src.strategies.generated.xauusd_snd_qm_structure_d1_v1 import (
