"""XAUUSD S&D + Quasimodo + Market Structure — H1 Short Swing preset.

Same core logic as the M1/M5/M15 presets but tuned for H1 entry
candles with H4 zone detection — a swing-style approach that captures
multi-session moves on larger structural zones.
...
H1 Short Swing: entries on 1-hour candles, zones detected on H4,
widest parameters for larger zone rectangles and swing targets.
...
class XauusdSndQmStructureH1:
    def __init__(self) -> None:
        self.spec = StrategySpec(
            name="xauusd_snd_qm_structure_fixed_h1",
            version=1,
            symbols=("XAUUSD",),
            entry_timeframe="H1",
