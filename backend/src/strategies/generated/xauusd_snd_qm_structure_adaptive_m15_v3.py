...
def _confluence_score(
    ...
    trending = (
        np.isfinite(adx_value)
        and adx_value >= params.get("adx_trend_threshold", 20.0)
        and trend_dir != 0
    )
    countertrend = trending and trend_dir != trade_dir
    if countertrend and structure_align != trade_dir and htf_align != trade_dir:
        return -1_000_000
