...
# (tp_distance = (sl_distance + spread) * TP_RR), the same formula
# SpreadGate applies at the broker gate, rather than relying on TP_RR
# headroom over min_rr to happen to absorb whatever the live spread is.
TP_RR = 2.2
