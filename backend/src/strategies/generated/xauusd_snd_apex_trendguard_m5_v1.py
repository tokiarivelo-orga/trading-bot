"""XAUUSD APEX — S&D + Quasimodo + Trend-Guard + Zone-Respect, M5 entries.

The M5 sibling of `xauusd_snd_apex_trendguard_m1_v1.py`. The algorithm is
...
────────────────────────────────────────────────────────────────────────
    entry / trigger      M5
    zone detection       M15
    higher-TF zones      H1      (confluence + Quasimodo confirmation)
    trend votes          M15 (w 1.0), H1 (w 1.5), H4 (w 2.0)
...
candles, not a resample of the entry frame: ~16h of M15, ~8 days of H1 and ~33 days of H4.
