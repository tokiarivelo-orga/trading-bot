"""XAUUSD S&D + Quasimodo + Market Structure — D1 Position preset.

Same core logic as the M1/M5/M15/H1 presets but tuned for Daily entry
candles with Weekly (W1) zone detection — a position-trading approach
that captures multi-week/multi-month moves on the largest structural
zones the family supports.
...
v1 — D1 variant scaffolded from xauusd_snd_qm_structure_h1_v4 (entry_tf
  H1->D1, zone_tf H4->W1) via the new-strategy skill, 2026-08-05.
...
class XauusdSndQmStructureD1:
    def __init__(self) -> None:
        self.spec = StrategySpec(
            name="xauusd_snd_qm_structure_d1",
            version=1,
            symbols=("XAUUSD",),
            entry_timeframe="D1",
